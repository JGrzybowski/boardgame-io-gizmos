...
export function BlockArchiveEffect(G: GameState, ctx: GameContext): GameState | string {
  ...
  const newPlayerState = new PlayerState({ ...playerState, isArchivingBlocked: true });
